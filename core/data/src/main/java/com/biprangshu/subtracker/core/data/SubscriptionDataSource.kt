package com.biprangshu.subtracker.core.data

import com.biprangshu.subtracker.core.data.R
...
object SubscriptionDataSource {
    val popularServices = listOf(
        ...
        SubscriptionService("Gemini Pro", R.drawable.gemini, 0xFF4B0082, "AI"),
        SubscriptionService("Claude Pro", R.drawable.claude, 0xFFFFA500, "AI"),
        SubscriptionService("SuperGrok", R.drawable.grok, 0xFF800080, "AI"),
        SubscriptionService("Perplexity Premium", R.drawable.perplexity, 0xFF008080, "AI"),
        ...
        SubscriptionService("X Premium", R.drawable.x_logo, 0xFF1DA1F2, "Social Media"),
