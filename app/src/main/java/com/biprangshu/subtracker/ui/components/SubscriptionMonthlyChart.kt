    ...
    ProvideVicoTheme(rememberM3VicoTheme()) {
        CartesianChartHost(
            chart = rememberCartesianChart(
                rememberColumnCartesianLayer(
                    ColumnCartesianLayer.ColumnProvider.series(
                        rememberLineComponent(
                            fill = fill(brush.toShaderProvider()),
                            thickness = thickness,
                            // Expressive Shape: "Squircle" top, flat bottom
                    ...
                    columnCollectionSpacing = 24.dp // More spacing between subscription bars
                ),
                startAxis = VerticalAxis.rememberStart(
                    ...
                    guideline = rememberLineComponent(
                        fill = fill(colorScheme.outlineVariant.copy(alpha = 0.4f)),
                        shape = DashedShape(
                ...
                marker = rememberDefaultCartesianMarker(
                    label = rememberTextComponent(
                        ...
                        padding = Insets(verticalDp = 6f, horizontalDp = 10f),
                    ),
            ...
            zoomState = rememberVicoZoomState(
                zoomEnabled = true,
                initialZoom = Zoom.Content, // Fit content since we only have 4 items
